...
NTSTATUS wrap_FT_SetVIDPID(void *args) {
    ...
    a->ret = xFT_SetVIDPID(a->dwVID, a->dwPID);
...
NTSTATUS wrap_FT_GetStatus(void *args) {
    ...
    printf("GetStatus\n");
    a->ret = xFT_GetStatus(a->ftHandle, a->lpdwAmountInRxQueue, a->lpdwAmountInTxQueue, a->lpdwEventStatus);
    return STATUS_SUCCESS;
}
...
NTSTATUS wrap_FT_Reload(void *args) {
    ...
    a->ret = xFT_Reload(a->wVID, a->wPID);
    return STATUS_SUCCESS;
}
...
NTSTATUS wrap_FT_SetResetPipeRetryCount(void *args) {
    ...
    a->ret = xFT_SetResetPipeRetryCount(a->ftHandle, a->dwCount);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_SetResetPipeRetryCount(void *args) {
    struct p32_FT_SetResetPipeRetryCount *a = args;
    a->ret = xFT_SetResetPipeRetryCount((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwCount);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_StopInTask(void *args) {
    struct prm_FT_StopInTask *a = args;
    a->ret = xFT_StopInTask(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_StopInTask(void *args) {
    struct p32_FT_StopInTask *a = args;
    a->ret = xFT_StopInTask((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_RestartInTask(void *args) {
    struct prm_FT_RestartInTask *a = args;
    a->ret = xFT_RestartInTask(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_RestartInTask(void *args) {
    struct p32_FT_RestartInTask *a = args;
    a->ret = xFT_RestartInTask((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_SetDeadmanTimeout(void *args) {
    struct prm_FT_SetDeadmanTimeout *a = args;
    a->ret = xFT_SetDeadmanTimeout(a->ftHandle, a->ulDeadmanTimeout);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_SetDeadmanTimeout(void *args) {
    struct p32_FT_SetDeadmanTimeout *a = args;
    a->ret = xFT_SetDeadmanTimeout((FT_HANDLE)ULongToPtr(a->ftHandle), a->ulDeadmanTimeout);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_IoCtl(void *args) {
    struct prm_FT_IoCtl *a = args;
    a->ret = xFT_IoCtl(a->ftHandle, a->dwIoControlCode, a->lpInBuf, a->nInBufSize, a->lpOutBuf, a->nOutBufSize, a->lpBytesReturned, a->lpOverlapped);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_IoCtl(void *args) {
    struct p32_FT_IoCtl *a = args;
    a->ret = xFT_IoCtl((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwIoControlCode, (LPVOID)ULongToPtr(a->lpInBuf), a->nInBufSize, (LPVOID)ULongToPtr(a->lpOutBuf), a->nOutBufSize, (LPDWORD)ULongToPtr(a->lpBytesReturned), (LPOVERLAPPED)ULongToPtr(a->lpOverlapped));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_SetWaitMask(void *args) {
    struct prm_FT_SetWaitMask *a = args;
    a->ret = xFT_SetWaitMask(a->ftHandle, a->Mask);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_SetWaitMask(void *args) {
    struct p32_FT_SetWaitMask *a = args;
    a->ret = xFT_SetWaitMask((FT_HANDLE)ULongToPtr(a->ftHandle), a->Mask);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_WaitOnMask(void *args) {
    struct prm_FT_WaitOnMask *a = args;
    a->ret = xFT_WaitOnMask(a->ftHandle, a->Mask);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_WaitOnMask(void *args) {
    struct p32_FT_WaitOnMask *a = args;
    a->ret = xFT_WaitOnMask((FT_HANDLE)ULongToPtr(a->ftHandle), (DWORD*)ULongToPtr(a->Mask));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_GetEventStatus(void *args) {
    struct prm_FT_GetEventStatus *a = args;
    a->ret = xFT_GetEventStatus(a->ftHandle, a->dwEventDWord);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_GetEventStatus(void *args) {
    struct p32_FT_GetEventStatus *a = args;
    a->ret = xFT_GetEventStatus((FT_HANDLE)ULongToPtr(a->ftHandle), (DWORD*)ULongToPtr(a->dwEventDWord));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_ReadEE(void *args) {
    struct prm_FT_ReadEE *a = args;
    a->ret = xFT_ReadEE(a->ftHandle, a->dwWordOffset, a->lpwValue);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_ReadEE(void *args) {
    struct p32_FT_ReadEE *a = args;
    a->ret = xFT_ReadEE((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwWordOffset, (LPWORD)ULongToPtr(a->lpwValue));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_WriteEE(void *args) {
    struct prm_FT_WriteEE *a = args;
    a->ret = xFT_WriteEE(a->ftHandle, a->dwWordOffset, a->wValue);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_WriteEE(void *args) {
    struct p32_FT_WriteEE *a = args;
    a->ret = xFT_WriteEE((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwWordOffset, a->wValue);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EraseEE(void *args) {
    struct prm_FT_EraseEE *a = args;
    a->ret = xFT_EraseEE(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EraseEE(void *args) {
    struct p32_FT_EraseEE *a = args;
    a->ret = xFT_EraseEE((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_Read(void *args) {
    struct prm_FT_EE_Read *a = args;
    a->ret = xFT_EE_Read(a->ftHandle, a->pData);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_Read(void *args) {
    struct p32_FT_EE_Read *a = args;
    a->ret = xFT_EE_Read((FT_HANDLE)ULongToPtr(a->ftHandle), (PFT_PROGRAM_DATA)ULongToPtr(a->pData));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_ReadEx(void *args) {
    struct prm_FT_EE_ReadEx *a = args;
    a->ret = xFT_EE_ReadEx(a->ftHandle, a->pData, a->Manufacturer, a->ManufacturerId, a->Description, a->SerialNumber);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_ReadEx(void *args) {
    struct p32_FT_EE_ReadEx *a = args;
    a->ret = xFT_EE_ReadEx((FT_HANDLE)ULongToPtr(a->ftHandle), (PFT_PROGRAM_DATA)ULongToPtr(a->pData), (char*)ULongToPtr(a->Manufacturer), (char*)ULongToPtr(a->ManufacturerId), (char*)ULongToPtr(a->Description), (char*)ULongToPtr(a->SerialNumber));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_Program(void *args) {
    struct prm_FT_EE_Program *a = args;
    a->ret = xFT_EE_Program(a->ftHandle, a->pData);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_Program(void *args) {
    struct p32_FT_EE_Program *a = args;
    a->ret = xFT_EE_Program((FT_HANDLE)ULongToPtr(a->ftHandle), (PFT_PROGRAM_DATA)ULongToPtr(a->pData));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_ProgramEx(void *args) {
    struct prm_FT_EE_ProgramEx *a = args;
    a->ret = xFT_EE_ProgramEx(a->ftHandle, a->pData, a->Manufacturer, a->ManufacturerId, a->Description, a->SerialNumber);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_ProgramEx(void *args) {
    struct p32_FT_EE_ProgramEx *a = args;
    a->ret = xFT_EE_ProgramEx((FT_HANDLE)ULongToPtr(a->ftHandle), (PFT_PROGRAM_DATA)ULongToPtr(a->pData), (char*)ULongToPtr(a->Manufacturer), (char*)ULongToPtr(a->ManufacturerId), (char*)ULongToPtr(a->Description), (char*)ULongToPtr(a->SerialNumber));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_UASize(void *args) {
    struct prm_FT_EE_UASize *a = args;
    a->ret = xFT_EE_UASize(a->ftHandle, a->lpdwSize);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_UASize(void *args) {
    struct p32_FT_EE_UASize *a = args;
    a->ret = xFT_EE_UASize((FT_HANDLE)ULongToPtr(a->ftHandle), (LPDWORD)ULongToPtr(a->lpdwSize));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_UARead(void *args) {
    struct prm_FT_EE_UARead *a = args;
    a->ret = xFT_EE_UARead(a->ftHandle, a->pucData, a->dwDataLen, a->lpdwBytesRead);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_UARead(void *args) {
    struct p32_FT_EE_UARead *a = args;
    a->ret = xFT_EE_UARead((FT_HANDLE)ULongToPtr(a->ftHandle), (PUCHAR)ULongToPtr(a->pucData), a->dwDataLen, (LPDWORD)ULongToPtr(a->lpdwBytesRead));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_UAWrite(void *args) {
    struct prm_FT_EE_UAWrite *a = args;
    a->ret = xFT_EE_UAWrite(a->ftHandle, a->pucData, a->dwDataLen);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_UAWrite(void *args) {
    struct p32_FT_EE_UAWrite *a = args;
    a->ret = xFT_EE_UAWrite((FT_HANDLE)ULongToPtr(a->ftHandle), (PUCHAR)ULongToPtr(a->pucData), a->dwDataLen);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EEPROM_Read(void *args) {
    struct prm_FT_EEPROM_Read *a = args;
    a->ret = xFT_EEPROM_Read(a->ftHandle, a->eepromData, a->eepromDataSize, a->Manufacturer, a->ManufacturerId, a->Description, a->SerialNumber);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EEPROM_Read(void *args) {
    struct p32_FT_EEPROM_Read *a = args;
    a->ret = xFT_EEPROM_Read((FT_HANDLE)ULongToPtr(a->ftHandle), (void*)ULongToPtr(a->eepromData), a->eepromDataSize, (char*)ULongToPtr(a->Manufacturer), (char*)ULongToPtr(a->ManufacturerId), (char*)ULongToPtr(a->Description), (char*)ULongToPtr(a->SerialNumber));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EEPROM_Program(void *args) {
    struct prm_FT_EEPROM_Program *a = args;
    a->ret = xFT_EEPROM_Program(a->ftHandle, a->eepromData, a->eepromDataSize, a->Manufacturer, a->ManufacturerId, a->Description, a->SerialNumber);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EEPROM_Program(void *args) {
    struct p32_FT_EEPROM_Program *a = args;
    a->ret = xFT_EEPROM_Program((FT_HANDLE)ULongToPtr(a->ftHandle), (void*)ULongToPtr(a->eepromData), a->eepromDataSize, (char*)ULongToPtr(a->Manufacturer), (char*)ULongToPtr(a->ManufacturerId), (char*)ULongToPtr(a->Description), (char*)ULongToPtr(a->SerialNumber));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_SetLatencyTimer(void *args) {
    struct prm_FT_SetLatencyTimer *a = args;
    a->ret = xFT_SetLatencyTimer(a->ftHandle, a->ucLatency);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_SetLatencyTimer(void *args) {
    struct p32_FT_SetLatencyTimer *a = args;
    a->ret = xFT_SetLatencyTimer((FT_HANDLE)ULongToPtr(a->ftHandle), a->ucLatency);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_GetLatencyTimer(void *args) {
    struct prm_FT_GetLatencyTimer *a = args;
    a->ret = xFT_GetLatencyTimer(a->ftHandle, a->pucLatency);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_GetLatencyTimer(void *args) {
    struct p32_FT_GetLatencyTimer *a = args;
    a->ret = xFT_GetLatencyTimer((FT_HANDLE)ULongToPtr(a->ftHandle), (PUCHAR)ULongToPtr(a->pucLatency));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_SetBitMode(void *args) {
    struct prm_FT_SetBitMode *a = args;
    a->ret = xFT_SetBitMode(a->ftHandle, a->ucMask, a->ucEnable);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_SetBitMode(void *args) {
    struct p32_FT_SetBitMode *a = args;
    a->ret = xFT_SetBitMode((FT_HANDLE)ULongToPtr(a->ftHandle), a->ucMask, a->ucEnable);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_GetBitMode(void *args) {
    struct prm_FT_GetBitMode *a = args;
    a->ret = xFT_GetBitMode(a->ftHandle, a->pucMode);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_GetBitMode(void *args) {
    struct p32_FT_GetBitMode *a = args;
    a->ret = xFT_GetBitMode((FT_HANDLE)ULongToPtr(a->ftHandle), (PUCHAR)ULongToPtr(a->pucMode));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_SetUSBParameters(void *args) {
    struct prm_FT_SetUSBParameters *a = args;
    a->ret = xFT_SetUSBParameters(a->ftHandle, a->ulInTransferSize, a->ulOutTransferSize);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_SetUSBParameters(void *args) {
    struct p32_FT_SetUSBParameters *a = args;
    a->ret = xFT_SetUSBParameters((FT_HANDLE)ULongToPtr(a->ftHandle), a->ulInTransferSize, a->ulOutTransferSize);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_CreateFile(void *args) {
    struct prm_FT_W32_CreateFile *a = args;
    a->ret = xFT_W32_CreateFile(a->lpszName, a->dwAccess, a->dwShareMode, a->lpSecurityAttributes, a->dwCreate, a->dwAttrsAndFlags, a->hTemplate);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_CreateFile(void *args) {
    struct p32_FT_W32_CreateFile *a = args;
    a->ret = xFT_W32_CreateFile((LPCTSTR)ULongToPtr(a->lpszName), a->dwAccess, a->dwShareMode, (LPSECURITY_ATTRIBUTES)ULongToPtr(a->lpSecurityAttributes), a->dwCreate, a->dwAttrsAndFlags, a->hTemplate);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_CloseHandle(void *args) {
    struct prm_FT_W32_CloseHandle *a = args;
    a->ret = xFT_W32_CloseHandle(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_CloseHandle(void *args) {
    struct p32_FT_W32_CloseHandle *a = args;
    a->ret = xFT_W32_CloseHandle((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_ReadFile(void *args) {
    struct prm_FT_W32_ReadFile *a = args;
    a->ret = xFT_W32_ReadFile(a->ftHandle, a->lpBuffer, a->nBufferSize, a->lpdwBytesReturned, a->lpOverlapped);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_ReadFile(void *args) {
    struct p32_FT_W32_ReadFile *a = args;
    a->ret = xFT_W32_ReadFile((FT_HANDLE)ULongToPtr(a->ftHandle), (LPVOID)ULongToPtr(a->lpBuffer), a->nBufferSize, (LPDWORD)ULongToPtr(a->lpdwBytesReturned), (LPOVERLAPPED)ULongToPtr(a->lpOverlapped));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_WriteFile(void *args) {
    struct prm_FT_W32_WriteFile *a = args;
    a->ret = xFT_W32_WriteFile(a->ftHandle, a->lpBuffer, a->nBufferSize, a->lpdwBytesWritten, a->lpOverlapped);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_WriteFile(void *args) {
    struct p32_FT_W32_WriteFile *a = args;
    a->ret = xFT_W32_WriteFile((FT_HANDLE)ULongToPtr(a->ftHandle), (LPVOID)ULongToPtr(a->lpBuffer), a->nBufferSize, (LPDWORD)ULongToPtr(a->lpdwBytesWritten), (LPOVERLAPPED)ULongToPtr(a->lpOverlapped));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_GetOverlappedResult(void *args) {
    struct prm_FT_W32_GetOverlappedResult *a = args;
    a->ret = xFT_W32_GetOverlappedResult(a->ftHandle, a->lpOverlapped, a->lpdwBytesTransferred, a->bWait);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_GetOverlappedResult(void *args) {
    struct p32_FT_W32_GetOverlappedResult *a = args;
    a->ret = xFT_W32_GetOverlappedResult((FT_HANDLE)ULongToPtr(a->ftHandle), (LPOVERLAPPED)ULongToPtr(a->lpOverlapped), (LPDWORD)ULongToPtr(a->lpdwBytesTransferred), a->bWait);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_EscapeCommFunction(void *args) {
    struct prm_FT_W32_EscapeCommFunction *a = args;
    a->ret = xFT_W32_EscapeCommFunction(a->ftHandle, a->dwFunc);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_EscapeCommFunction(void *args) {
    struct p32_FT_W32_EscapeCommFunction *a = args;
    a->ret = xFT_W32_EscapeCommFunction((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwFunc);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_GetCommModemStatus(void *args) {
    struct prm_FT_W32_GetCommModemStatus *a = args;
    a->ret = xFT_W32_GetCommModemStatus(a->ftHandle, a->lpdwModemStatus);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_GetCommModemStatus(void *args) {
    struct p32_FT_W32_GetCommModemStatus *a = args;
    a->ret = xFT_W32_GetCommModemStatus((FT_HANDLE)ULongToPtr(a->ftHandle), (LPDWORD)ULongToPtr(a->lpdwModemStatus));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_SetupComm(void *args) {
    struct prm_FT_W32_SetupComm *a = args;
    a->ret = xFT_W32_SetupComm(a->ftHandle, a->dwReadBufferSize, a->dwWriteBufferSize);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_SetupComm(void *args) {
    struct p32_FT_W32_SetupComm *a = args;
    a->ret = xFT_W32_SetupComm((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwReadBufferSize, a->dwWriteBufferSize);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_SetCommState(void *args) {
    struct prm_FT_W32_SetCommState *a = args;
    a->ret = xFT_W32_SetCommState(a->ftHandle, a->lpftDcb);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_SetCommState(void *args) {
    struct p32_FT_W32_SetCommState *a = args;
    a->ret = xFT_W32_SetCommState((FT_HANDLE)ULongToPtr(a->ftHandle), (LPFTDCB)ULongToPtr(a->lpftDcb));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_GetCommState(void *args) {
    struct prm_FT_W32_GetCommState *a = args;
    a->ret = xFT_W32_GetCommState(a->ftHandle, a->lpftDcb);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_GetCommState(void *args) {
    struct p32_FT_W32_GetCommState *a = args;
    a->ret = xFT_W32_GetCommState((FT_HANDLE)ULongToPtr(a->ftHandle), (LPFTDCB)ULongToPtr(a->lpftDcb));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_SetCommTimeouts(void *args) {
    struct prm_FT_W32_SetCommTimeouts *a = args;
    a->ret = xFT_W32_SetCommTimeouts(a->ftHandle, a->pftTimeouts);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_SetCommTimeouts(void *args) {
    struct p32_FT_W32_SetCommTimeouts *a = args;
    a->ret = xFT_W32_SetCommTimeouts((FT_HANDLE)ULongToPtr(a->ftHandle), (FTTIMEOUTS*)ULongToPtr(a->pftTimeouts));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_GetCommTimeouts(void *args) {
    struct prm_FT_W32_GetCommTimeouts *a = args;
    a->ret = xFT_W32_GetCommTimeouts(a->ftHandle, a->pftTimeouts);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_GetCommTimeouts(void *args) {
    struct p32_FT_W32_GetCommTimeouts *a = args;
    a->ret = xFT_W32_GetCommTimeouts((FT_HANDLE)ULongToPtr(a->ftHandle), (FTTIMEOUTS*)ULongToPtr(a->pftTimeouts));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_SetCommBreak(void *args) {
    struct prm_FT_W32_SetCommBreak *a = args;
    a->ret = xFT_W32_SetCommBreak(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_SetCommBreak(void *args) {
    struct p32_FT_W32_SetCommBreak *a = args;
    a->ret = xFT_W32_SetCommBreak((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_ClearCommBreak(void *args) {
    struct prm_FT_W32_ClearCommBreak *a = args;
    a->ret = xFT_W32_ClearCommBreak(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_ClearCommBreak(void *args) {
    struct p32_FT_W32_ClearCommBreak *a = args;
    a->ret = xFT_W32_ClearCommBreak((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_SetCommMask(void *args) {
    struct prm_FT_W32_SetCommMask *a = args;
    a->ret = xFT_W32_SetCommMask(a->ftHandle, a->ulEventMask);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_SetCommMask(void *args) {
    struct p32_FT_W32_SetCommMask *a = args;
    a->ret = xFT_W32_SetCommMask((FT_HANDLE)ULongToPtr(a->ftHandle), a->ulEventMask);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_WaitCommEvent(void *args) {
    struct prm_FT_W32_WaitCommEvent *a = args;
    a->ret = xFT_W32_WaitCommEvent(a->ftHandle, a->pulEvent, a->lpOverlapped);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_WaitCommEvent(void *args) {
    struct p32_FT_W32_WaitCommEvent *a = args;
    a->ret = xFT_W32_WaitCommEvent((FT_HANDLE)ULongToPtr(a->ftHandle), (PULONG)ULongToPtr(a->pulEvent), (LPOVERLAPPED)ULongToPtr(a->lpOverlapped));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_PurgeComm(void *args) {
    struct prm_FT_W32_PurgeComm *a = args;
    a->ret = xFT_W32_PurgeComm(a->ftHandle, a->dwMask);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_PurgeComm(void *args) {
    struct p32_FT_W32_PurgeComm *a = args;
    a->ret = xFT_W32_PurgeComm((FT_HANDLE)ULongToPtr(a->ftHandle), a->dwMask);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_ClearCommError(void *args) {
    struct prm_FT_W32_ClearCommError *a = args;
    a->ret = xFT_W32_ClearCommError(a->ftHandle, a->lpdwErrors, a->lpftComstat);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_ClearCommError(void *args) {
    struct p32_FT_W32_ClearCommError *a = args;
    a->ret = xFT_W32_ClearCommError((FT_HANDLE)ULongToPtr(a->ftHandle), (LPDWORD)ULongToPtr(a->lpdwErrors), (LPFTCOMSTAT)ULongToPtr(a->lpftComstat));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_W32_CancelIo(void *args) {
    struct prm_FT_W32_CancelIo *a = args;
    a->ret = xFT_W32_CancelIo(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_W32_CancelIo(void *args) {
    struct p32_FT_W32_CancelIo *a = args;
    a->ret = xFT_W32_CancelIo((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_ReadConfig(void *args) {
    struct prm_FT_EE_ReadConfig *a = args;
    a->ret = xFT_EE_ReadConfig(a->ftHandle, a->ucAddress, a->pucValue);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_ReadConfig(void *args) {
    struct p32_FT_EE_ReadConfig *a = args;
    a->ret = xFT_EE_ReadConfig((FT_HANDLE)ULongToPtr(a->ftHandle), a->ucAddress, (PUCHAR)ULongToPtr(a->pucValue));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_WriteConfig(void *args) {
    struct prm_FT_EE_WriteConfig *a = args;
    a->ret = xFT_EE_WriteConfig(a->ftHandle, a->ucAddress, a->ucValue);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_WriteConfig(void *args) {
    struct p32_FT_EE_WriteConfig *a = args;
    a->ret = xFT_EE_WriteConfig((FT_HANDLE)ULongToPtr(a->ftHandle), a->ucAddress, a->ucValue);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_EE_ReadECC(void *args) {
    struct prm_FT_EE_ReadECC *a = args;
    a->ret = xFT_EE_ReadECC(a->ftHandle, a->ucOption, a->lpwValue);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_EE_ReadECC(void *args) {
    struct p32_FT_EE_ReadECC *a = args;
    a->ret = xFT_EE_ReadECC((FT_HANDLE)ULongToPtr(a->ftHandle), a->ucOption, (LPWORD)ULongToPtr(a->lpwValue));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_GetQueueStatusEx(void *args) {
    struct prm_FT_GetQueueStatusEx *a = args;
    a->ret = xFT_GetQueueStatusEx(a->ftHandle, a->dwRxBytes);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_GetQueueStatusEx(void *args) {
    struct p32_FT_GetQueueStatusEx *a = args;
    a->ret = xFT_GetQueueStatusEx((FT_HANDLE)ULongToPtr(a->ftHandle), (DWORD*)ULongToPtr(a->dwRxBytes));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_ComPortIdle(void *args) {
    struct prm_FT_ComPortIdle *a = args;
    a->ret = xFT_ComPortIdle(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_ComPortIdle(void *args) {
    struct p32_FT_ComPortIdle *a = args;
    a->ret = xFT_ComPortIdle((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_ComPortCancelIdle(void *args) {
    struct prm_FT_ComPortCancelIdle *a = args;
    a->ret = xFT_ComPortCancelIdle(a->ftHandle);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_ComPortCancelIdle(void *args) {
    struct p32_FT_ComPortCancelIdle *a = args;
    a->ret = xFT_ComPortCancelIdle((FT_HANDLE)ULongToPtr(a->ftHandle));
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_VendorCmdGet(void *args) {
    struct prm_FT_VendorCmdGet *a = args;
    a->ret = xFT_VendorCmdGet(a->ftHandle, a->Request, a->Buf, a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_VendorCmdGet(void *args) {
    struct p32_FT_VendorCmdGet *a = args;
    a->ret = xFT_VendorCmdGet((FT_HANDLE)ULongToPtr(a->ftHandle), a->Request, (UCHAR*)ULongToPtr(a->Buf), a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_VendorCmdSet(void *args) {
    struct prm_FT_VendorCmdSet *a = args;
    a->ret = xFT_VendorCmdSet(a->ftHandle, a->Request, a->Buf, a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_VendorCmdSet(void *args) {
    struct p32_FT_VendorCmdSet *a = args;
    a->ret = xFT_VendorCmdSet((FT_HANDLE)ULongToPtr(a->ftHandle), a->Request, (UCHAR*)ULongToPtr(a->Buf), a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_VendorCmdGetEx(void *args) {
    struct prm_FT_VendorCmdGetEx *a = args;
    a->ret = xFT_VendorCmdGetEx(a->ftHandle, a->wValue, a->Buf, a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_VendorCmdGetEx(void *args) {
    struct p32_FT_VendorCmdGetEx *a = args;
    a->ret = xFT_VendorCmdGetEx((FT_HANDLE)ULongToPtr(a->ftHandle), a->wValue, (UCHAR*)ULongToPtr(a->Buf), a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wrap_FT_VendorCmdSetEx(void *args) {
    struct prm_FT_VendorCmdSetEx *a = args;
    a->ret = xFT_VendorCmdSetEx(a->ftHandle, a->wValue, a->Buf, a->Len);
    return STATUS_SUCCESS;
}

NTSTATUS wow64_wrap_FT_VendorCmdSetEx(void *args) {
    struct p32_FT_VendorCmdSetEx *a = args;
    a->ret = xFT_VendorCmdSetEx((FT_HANDLE)ULongToPtr(a->ftHandle), a->wValue, (UCHAR*)ULongToPtr(a->Buf), a->Len);
    return STATUS_SUCCESS;
}
